...
export const ActivityRow = ({ event }) => {
      ...
      <a>
        <ActivityGridRow>
          <ActivityInfo className="type">
            <ActivityInfoText>
              <ActivityIcon>
                {activityIconRegistry[event.event_type]}
              </ActivityIcon>
              ...
              <ActivityText>
                <CollectionName>
                  <Link
                    href={
                      event.token.collection.slug
                        ...
                        : `/collection/${
                            event.token.network != siteConfig.NETWORK
                              ? "eth/"
                              : ""
                          }${event.token.contract_address}`
                    }
                  >
                    <a>
                      <TextTruncater>
                        {event.token.collection.name}
                      </TextTruncater>
                      {event.token.collection.verified && (
                        <VerifiedIcon>
                          <MdVerified />
                        </VerifiedIcon>
                      )}
                ...
                <TokenName>
                  <TextTruncater>{event.token.name}</TextTruncater>
                </TokenName>
              </ActivityText>
            </ActivityInfo>
          ...
          <ActivityGridMobileRow className="bottom">
            ...
            {event.txn_id ? (
              ...
              >
                <DateContainer>
                  <ActivityInfo className="title mobile date">
                    Date
                  </ActivityInfo>
