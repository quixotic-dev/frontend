export const rewardsWrapperABI = [
  ...
  {
    inputs: [
      { internalType: "contract Seaport", name: "_seaport", type: "address" },
      {
  ...
  },
  {
    ...
    name: "rewardDeriver",
    outputs: [
      { internalType: "contract IRewardDeriver", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  {
    inputs: [],
    name: "seaport",
    outputs: [{ internalType: "contract Seaport", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
